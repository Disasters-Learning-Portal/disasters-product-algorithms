...
def ls_merge(dir_to_merge, mask=False, method='first'):
  ...
  if mask:
    print('\t* Applying Cloud Mask')
    # Find the merged cloud mask. Use *merged*.tif (not *merged.tif): by this
    # point the merged cloud mask has been renamed to e.g.
    # LC08_cloudMask_merged_2026-06-06_day.tif (date moved to end + _day suffix),
