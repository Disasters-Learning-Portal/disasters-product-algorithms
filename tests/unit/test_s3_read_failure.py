...
message-mapper the list-dates discovery path (``dps/list_dates/report_dates.py``)
uses to turn a vendor-bucket read failure into ONE operator-facing line instead
of a raw boto3 traceback.
